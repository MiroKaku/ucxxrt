...
//
// This source file provides a fallback definition of __dyn_tls_dtor_callback,
// used whenever TLS destructor is not required.
//
...
const PIMAGE_TLS_CALLBACK __dyn_tls_dtor_callback;
