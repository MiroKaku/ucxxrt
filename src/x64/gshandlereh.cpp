 ...
 * FILE:      gshandlereh.cpp - Defines __GSHandlerCheck_EH for X64
 * DATA:      2020/02/05
 *
 * PURPOSE:   Defines __GSHandlerCheck_EH, the X64 exception handler for functions
 *            with /GS-protected buffers as well as C++ EH constructs based on __CxxFrameHandler.
 *
