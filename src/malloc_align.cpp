...
static void __cdecl _aligned_free_base(
    _Pre_maybenull_ _Post_invalid_ void* block
);

_Check_return_ _Ret_maybenull_ _Post_writable_byte_size_(size)
static void* __cdecl _aligned_malloc_base(
    _In_ size_t size,
    _In_ size_t alignment
);

_Check_return_
static size_t __cdecl _aligned_msize_base(
...
_Check_return_ _Ret_maybenull_ _Post_writable_byte_size_(size)
static void* __cdecl _aligned_offset_malloc_base(
    _In_ size_t size,
    _In_ size_t alignment,
    _In_ size_t offset
);
...
static void* __cdecl _aligned_offset_realloc_base(
    _Pre_maybenull_ _Post_invalid_ void* block,
    _In_                           size_t size,
    _In_                           size_t alignment,
    _In_                           size_t offset
...
static void* __cdecl _aligned_offset_recalloc_base(
    _Pre_maybenull_ _Post_invalid_ void* block,
    _In_                           size_t count,
    _In_                           size_t size,
    _In_                           size_t alignment,
...
_Success_(return != 0) _Check_return_ _Ret_maybenull_ _Post_writable_byte_size_(size)
static void* __cdecl _aligned_realloc_base(
    _Pre_maybenull_ _Post_invalid_ void* block,
    _In_                           size_t size,
    _In_                           size_t alignment
);
...
_Success_(return != 0) _Check_return_ _Ret_maybenull_ _Post_writable_byte_size_(size * count)
static void* __cdecl _aligned_recalloc_base(
    _Pre_maybenull_ _Post_invalid_ void* block,
    _In_                           size_t count,
    _In_                           size_t size,
    _In_                           size_t alignment
