...
namespace ucxxrt
{
    ...
    EXTERN_C _VCRTIMP void* __AdjustPointer(
    ...
    // Side-effects:
    //     NONE.
    EXTERN_C _VCRTIMP void* __GetPlatformExceptionInfo(
        int* pIsBadAlloc
    ) {
        *pIsBadAlloc = 0;
    ...
    {
        return &RENAME_BASE_PTD(__ucxxrt_getptd)()->_curexception;
    }

    EXTERN_C void** __cdecl __current_exception_context()
    {
        return &RENAME_BASE_PTD(__ucxxrt_getptd)()->_curcontext;
    }

    EXTERN_C int* __cdecl __processing_throw()
    {
        return &RENAME_BASE_PTD(__ucxxrt_getptd)()->_ProcessingThrow;
    }
#endif
    ...
    EXTERN_C _VCRTIMP void __cdecl _SetWinRTOutOfMemoryExceptionCallback(PGETWINRT_OOM_EXCEPTION pCallback)
    {
    ...
    EXTERN_C __declspec(noreturn) void __cdecl __std_terminate()
    {
        terminate();
    }
